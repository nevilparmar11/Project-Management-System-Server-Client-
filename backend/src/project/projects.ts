export const Project = {
  ...
  url: 'https://github.com/nevilparmar11/project-management-system',
  description: 'Project Management System - by nevilparmar11',
  category: 'Software',
  ...
  issues: [
    ...
    },
    {
      ...
      description:
        "<h1>No official guide to configure TailwindCSS and Angular<strong>⛏️⛏️</strong></h1><p><br></p><p>It took me few hours to try and configure with different option. Also, was confuse when PurgeCSS remove ng-zorro style...</p><p><br></p><p>I wrote one myself</p><p><br></p><p><a href='https://nevilparmar11.com/experience/configure-tailwind-css-with-angular/' rel='noopener noreferrer' target='_blank'>https://nevilparmar11.com/experience/configure-tailwind-css-with-angular/</a></p><p><br></p>",
      type: 'Task',
      status: 'Done',
      priority: 'Medium',
      listPosition: 2,
    ...
    },
    {
      ...
      description:
        "<h3>Hi! My name is Trung.</h3><p>I’m the only front-end engineer at Zyllem, where I work mostly with Angular to build client side web app. I love thinking about development and user experience. </p><br/><p>Find me around the web</p><p><br></p><ul><li>My blog: <a href='https://nevilparmar11.com/' rel='noopener noreferrer' target='_blank'>https://nevilparmar11.com/</a></li><li><a href='https://github.com/nevilparmar11' rel='noopener noreferrer' target='_blank'>https://github.com/nevilparmar11</a></li><li><a href='https://stackoverflow.com/users/3375906/nevilparmar11' rel='noopener noreferrer' target='_blank'>https://stackoverflow.com/users/3375906/nevilparmar11</a></li></ul><p><br></p>",
      type: 'Task',
      status: 'Backlog',
      priority: 'High',
      listPosition: 3,
